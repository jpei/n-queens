...
(function() {
  ...
  window.Board = Backbone.Model.extend({
    ...
    hasAnyQueensConflicts: function() { // O(n^2)
 ...
 */
    ...
    hasRowConflictAt: function(rowIndex) {
      ...
      var count = 0;
      for (var i=0; i<this.grid[rowIndex].length; i++) {
        count += this.grid[rowIndex][i];
      }
      return count > 1;
    },
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      if (Math.abs(majorDiagonalColumnIndexAtFirstRow)>=this.get('n'))
        return false;
      var count = 0;
      var steps = 0;
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      if (minorDiagonalColumnIndexAtFirstRow < 0 || minorDiagonalColumnIndexAtFirstRow>2*this.get('n')-2)
        return false;
      var count = 0;
      var steps = 0;
